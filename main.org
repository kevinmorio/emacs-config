...
#+LAST_MODIFIED: [2023-03-20 Mon 23:28]
#+STARTUP: indent
...
#+begin_src emacs-lisp
  ...
  (defvar km/org-gtd-projects-file "~/Nextcloud/org/gtd/projects.org"    "File of project actions and notes")
           ...
           ((agenda ""
            ...
            (todo "WAITING|DELEGATED|HOLD"
                  ((org-agenda-overriding-header "Waiting / Delegated / Hold Actions")
                   ...
                   (org-agenda-sorting-strategy '(user-defined-up))
                   (org-agenda-prefix-format " %i %-25:c")))
            (tags "project-TODO=\"DONE\"-TODO=\"CANCELED\""
...
#+begin_src emacs-lisp
  ...
  (setq km/org-roam-targets (->> (directory-files-recursively km/org-roam-dir org-agenda-file-regexp)
                                      (--map `(,it :maxlevel . 9))))

  (setq org-refile-targets (append (list `(,km/org-gtd-next-file :maxlevel . 9)
                                         `(,km/org-gtd-someday-file :level . 0)
                                         `(,km/org-gtd-projects-file :level . 1)
